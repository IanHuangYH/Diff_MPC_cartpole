...
MODEL_PATH = '/MPC_DynamicSys/code/cart_pole_diffusion_based_on_MPD/trained_models/420000_models_with_noisy_data/230000' # the absolute path of the trained model
